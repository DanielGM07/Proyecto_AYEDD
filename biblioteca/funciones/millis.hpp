...
// Vos le pasas una fecha en forma de sus atributos y la funcion te lo devuelve como milisegundos
...
// Le pasas una fecha en formato de milisegundos y la funcion te lo va devolver como sus atributos
