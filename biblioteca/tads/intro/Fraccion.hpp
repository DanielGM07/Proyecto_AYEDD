...
//     Fraccion ret;
//     int numRet = ((f.numerador) * escalar);
//     int denRet = f.denominador;
//     ret.numerador = numRet;
//     ret.denominador = denRet;
//     return ret;
// }
...
//     Fraccion ret;
//     int numRet = ((f.numerador) * (g.numerador));
//     int denRet = ((f.denominador) * (g.denominador));
//     ret.numerador = numRet;
//     ret.denominador = denRet;
//     return ret;
// }
...
Fraccion fraccionMultiplicar(Fraccion f, int escalar){
    ...
    // El numerador de la funcion resultante va a ser igual a el numerador de la fraccion que pasamos por el escalar que le pasamos
    int numRet = ((f.numerador) * escalar);
    int denRet = f.denominador;
    ret.numerador = numRet;
    ret.denominador = denRet;
